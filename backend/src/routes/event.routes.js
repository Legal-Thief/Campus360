...
// Feature 2: Waitlist
router.post(  "/:eventId/waitlist/join",  protect, roleMiddleware("student"),             joinWaitlist);
router.delete("/:eventId/waitlist/leave", protect, roleMiddleware("student"),             leaveWaitlist);
router.get(   "/:eventId/waitlist",       protect, roleMiddleware("admin", "superadmin"), getWaitlist);

// Feature 3: OD / Attendance
router.post("/:eventId/finalize-attendance", protect, roleMiddleware("admin", "superadmin"), finalizeAttendance);
router.get( "/:eventId/my-od",               protect, roleMiddleware("student"),             getMyOD);
